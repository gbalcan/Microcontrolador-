...
F:G$isr_tc2$0$0({2}DF,SV:S),C,0,0,1,5,0
...
S:Lmain.esc_glcd$byte$1$31({1}SC:U),R,0,0,[r7]
S:Lmain.conf_Y$y$1$35({1}SC:U),R,0,0,[r7]
S:Lmain.conf_pag$pag$1$37({1}SC:U),R,0,0,[r7]
S:Lmain.limpa_glcd$i$1$40({1}SC:U),R,0,0,[r7]
S:Lmain.limpa_glcd$j$1$40({1}SC:U),R,0,0,[r6]
S:Lmain.putchar$count$1$43({1}SC:U),E,0,0
S:Lmain.putchar$c$1$42({1}SC:U),R,0,0,[r7]
S:Lmain.putchar$i$1$43({1}SC:U),R,0,0,[r5]
S:Lmain.putchar$cs$1$43({1}SC:U),R,0,0,[r6]
S:Lmain.esc_DAC0$v$1$46({4}SF:S),R,0,0,[r4,r5,r6,r7]
S:G$i$0$0({2}SI:U),E,0,0
S:Lmain.le_glcd$cd$1$29({1}SB0$1:U),H,0,0
S:Lmain.le_glcd$cs$1$29({1}SB0$1:U),H,0,0
S:Lmain.esc_glcd$cd$1$31({1}SB0$1:U),H,0,0
S:Lmain.esc_glcd$cs$1$31({1}SB0$1:U),H,0,0
S:Lmain.conf_Y$cs$1$35({1}SB0$1:U),H,0,0
S:Lmain.conf_pag$cs$1$37({1}SB0$1:U),H,0,0
S:Lmain.limpa_glcd$cs$1$39({1}SB0$1:U),H,0,0
...
S:G$isr_tc2$0$0({2}DF,SV:S),C,0,0
S:G$main$0$0({2}DF,SV:S),C,0,0
S:G$amostras$0$0({30000}DA30000d,SC:U),D,0,0

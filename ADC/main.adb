...
S:Lmain.esc_glcd$byte$1$32({1}SC:U),R,0,0,[r7]
S:Lmain.conf_Y$y$1$36({1}SC:U),R,0,0,[r7]
S:Lmain.conf_pag$pag$1$38({1}SC:U),R,0,0,[r7]
S:Lmain.limpa_glcd$i$1$41({1}SC:U),R,0,0,[r7]
S:Lmain.limpa_glcd$j$1$41({1}SC:U),R,0,0,[r6]
S:Lmain.putchar$count$1$44({1}SC:U),E,0,0
S:Lmain.putchar$c$1$43({1}SC:U),R,0,0,[r7]
S:Lmain.putchar$i$1$44({1}SC:U),R,0,0,[r5]
S:Lmain.putchar$cs$1$44({1}SC:U),R,0,0,[r6]
S:Lmain.esc_DAC0$v$1$47({4}SF:S),R,0,0,[r4,r5,r6,r7]
S:Lmain.main$ladc$1$51({2}SI:U),R,0,0,[r6,r7]
S:Lmain.le_glcd$cd$1$30({1}SB0$1:U),H,0,0
S:Lmain.le_glcd$cs$1$30({1}SB0$1:U),H,0,0
S:Lmain.esc_glcd$cd$1$32({1}SB0$1:U),H,0,0
S:Lmain.esc_glcd$cs$1$32({1}SB0$1:U),H,0,0
S:Lmain.conf_Y$cs$1$36({1}SB0$1:U),H,0,0
S:Lmain.conf_pag$cs$1$38({1}SB0$1:U),H,0,0
S:Lmain.limpa_glcd$cs$1$40({1}SB0$1:U),H,0,0
...
S:Fmain$__str_0$0$0({14}DA14d,SC:S),D,0,0

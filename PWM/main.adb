...
F:G$int_serial$0$0({2}DF,SV:S),C,0,0,1,4,0
...
S:Lmain.esc_glcd$byte$1$33({1}SC:U),R,0,0,[r7]
S:Lmain.conf_Y$y$1$37({1}SC:U),R,0,0,[r7]
S:Lmain.conf_pag$pag$1$39({1}SC:U),R,0,0,[r7]
S:Lmain.limpa_glcd$i$1$42({1}SC:U),R,0,0,[r7]
S:Lmain.limpa_glcd$j$1$42({1}SC:U),R,0,0,[r6]
S:Lmain.le_glcd$cd$1$31({1}SB0$1:U),H,0,0
S:Lmain.le_glcd$cs$1$31({1}SB0$1:U),H,0,0
S:Lmain.esc_glcd$cd$1$33({1}SB0$1:U),H,0,0
S:Lmain.esc_glcd$cs$1$33({1}SB0$1:U),H,0,0
S:Lmain.conf_Y$cs$1$37({1}SB0$1:U),H,0,0
S:Lmain.conf_pag$cs$1$39({1}SB0$1:U),H,0,0
S:Lmain.limpa_glcd$cs$1$41({1}SB0$1:U),H,0,0
S:G$fbr$0$0({1}SB0$1:U),H,0,0
...
S:G$int_serial$0$0({2}DF,SV:S),C,0,0
S:G$main$0$0({2}DF,SV:S),C,0,0
S:G$fonte$0$0({480}DA96d,DA5d,SC:U),D,0,0
S:Fmain$__str_0$0$0({4}DA4d,SC:S),D,0,0
S:Fmain$__str_1$0$0({6}DA6d,SC:S),D,0,0
S:Fmain$__str_2$0$0({19}DA19d,SC:S),D,0,0
S:Fmain$__str_3$0$0({27}DA27d,SC:S),D,0,0
S:Fmain$__str_4$0$0({27}DA27d,SC:S),D,0,0

      ...
      000003 02 00 D1         [24] 1258 	ljmp	_main
                           ...
                           000000  1268 	C$config.c$10$0$0 ==.
                                   1269 ;	Z:\micro\delay_us\/config.c:10: void Reset_Sources_Init()
                                   1270 ;	-----------------------------------------
      ...
      000062                       1273 _Reset_Sources_Init:
                           ...
                           000000  1282 	C$config.c$12$1$1 ==.
                                   1283 ;	Z:\micro\delay_us\/config.c:12: WDTCN     = 0xDE;
      000062 75 FF DE         [24] 1284 	mov	_WDTCN,#0xde
                           000003  1285 	C$config.c$13$1$1 ==.
                                   1286 ;	Z:\micro\delay_us\/config.c:13: WDTCN     = 0xAD;
      ...
      000068 22               [24] 1290 	ret
                           ...
                           000007  1295 	C$config.c$16$1$1 ==.
                                   1296 ;	Z:\micro\delay_us\/config.c:16: void Timer_Init()
                                   1297 ;	-----------------------------------------
                                   1298 ;	 function Timer_Init
                                   1299 ;	-----------------------------------------
      000069                       1300 _Timer_Init:
                           000007  1301 	C$config.c$18$1$2 ==.
                                   1302 ;	Z:\micro\delay_us\/config.c:18: SFRPAGE   = TIMER01_PAGE;
      000069 75 84 00         [24] 1303 	mov	_SFRPAGE,#0x00
                           00000A  1304 	C$config.c$19$1$2 ==.
                                   1305 ;	Z:\micro\delay_us\/config.c:19: CKCON     = 0x08;
      ...
      000079 22               [24] 1331 	ret
                           ...
                           000018  1338 	C$config.c$65$1$3 ==.
                                   1339 ;	Z:\micro\delay_us\/config.c:65: void Oscillator_Init()
                                   1340 ;	-----------------------------------------
                                   1341 ;	 function Oscillator_Init
                                   1342 ;	-----------------------------------------
      00007A                       1343 _Oscillator_Init:
                           000018  1344 	C$config.c$68$1$4 ==.
                                   1345 ;	Z:\micro\delay_us\/config.c:68: SFRPAGE   = CONFIG_PAGE;
      00007A 75 84 0F         [24] 1346 	mov	_SFRPAGE,#0x0f
                           00001B  1347 	C$config.c$69$1$4 ==.
                                   1348 ;	Z:\micro\delay_us\/config.c:69: OSCXCN    = 0x67;
      00007D 75 8C 67         [24] 1349 	mov	_OSCXCN,#0x67
                           00001E  1350 	C$config.c$70$1$4 ==.
                                   1351 ;	Z:\micro\delay_us\/config.c:70: for (i = 0; i < 3000; i++);  // Wait 1ms for initialization
      ...
      0000A9 22               [24] 1401 	ret
                                   1402 ;------------------------------------------------------------
                                   1403 ;Allocation info for local variables in function 'delay_us'
                                   1404 ;------------------------------------------------------------
                                   1405 ;t                         Allocated to registers r6 r7 
                                   1406 ;------------------------------------------------------------
                           000048  1407 	G$delay_us$0$0 ==.
                           000048  1408 	C$main.c$4$1$6 ==.
                                   1409 ;	Z:\micro\delay_us\main.c:4: void delay_us(unsigned int t)
                                   1410 ;	-----------------------------------------
                                   1411 ;	 function delay_us
                                   1412 ;	-----------------------------------------
      0000AA                       1413 _delay_us:
      0000AA AE 82            [24] 1414 	mov	r6,dpl
      0000AC AF 83            [24] 1415 	mov	r7,dph
                           00004C  1416 	C$main.c$6$1$8 ==.
                                   1417 ;	Z:\micro\delay_us\main.c:6: TR0 = 0;
      0000AE C2 8C            [12] 1418 	clr	_TR0
                           00004E  1419 	C$main.c$7$1$8 ==.
                                   1420 ;	Z:\micro\delay_us\main.c:7: TF0 = 0;
      0000B0 C2 8D            [12] 1421 	clr	_TF0
                           000050  1422 	C$main.c$8$1$8 ==.
                                   1423 ;	Z:\micro\delay_us\main.c:8: TMOD &= 0xFC;
      0000B2 53 89 FC         [24] 1424 	anl	_TMOD,#0xfc
                           000053  1425 	C$main.c$9$1$8 ==.
                                   1426 ;	Z:\micro\delay_us\main.c:9: TMOD |= 0x02;
      0000B5 43 89 02         [24] 1427 	orl	_TMOD,#0x02
                           000056  1428 	C$main.c$10$1$8 ==.
                                   1429 ;	Z:\micro\delay_us\main.c:10: TL0 = 0xE7;
      0000B8 75 8A E7         [24] 1430 	mov	_TL0,#0xe7
                           000059  1431 	C$main.c$11$1$8 ==.
                                   1432 ;	Z:\micro\delay_us\main.c:11: TH0 = 0xE7;
      0000BB 75 8C E7         [24] 1433 	mov	_TH0,#0xe7
                           00005C  1434 	C$main.c$12$1$8 ==.
                                   1435 ;	Z:\micro\delay_us\main.c:12: TR0 = 1;
      0000BE D2 8C            [12] 1436 	setb	_TR0
                           00005E  1437 	C$main.c$14$1$8 ==.
                                   1438 ;	Z:\micro\delay_us\main.c:14: while(t)
      0000C0                       1439 00104$:
      0000C0 EE               [12] 1440 	mov	a,r6
      0000C1 4F               [12] 1441 	orl	a,r7
      0000C2 60 0C            [24] 1442 	jz	00107$
                           000062  1443 	C$main.c$16$2$9 ==.
                                   1444 ;	Z:\micro\delay_us\main.c:16: while (TF0 != 1);
      0000C4                       1445 00101$:
                           000062  1446 	C$main.c$17$2$9 ==.
                                   1447 ;	Z:\micro\delay_us\main.c:17: TF0 = 0;
      0000C4 10 8D 02         [24] 1448 	jbc	_TF0,00120$
      0000C7 80 FB            [24] 1449 	sjmp	00101$
      0000C9                       1450 00120$:
                           000067  1451 	C$main.c$18$2$9 ==.
                                   1452 ;	Z:\micro\delay_us\main.c:18: t--;
      0000C9 1E               [12] 1453 	dec	r6
      0000CA BE FF 01         [24] 1454 	cjne	r6,#0xff,00121$
      0000CD 1F               [12] 1455 	dec	r7
      0000CE                       1456 00121$:
      0000CE 80 F0            [24] 1457 	sjmp	00104$
      0000D0                       1458 00107$:
                           00006E  1459 	C$main.c$20$1$8 ==.
                           00006E  1460 	XG$delay_us$0$0 ==.
      0000D0 22               [24] 1461 	ret
                                   1462 ;------------------------------------------------------------
                                   1463 ;Allocation info for local variables in function 'main'
                                   1464 ;------------------------------------------------------------
                           00006F  1465 	G$main$0$0 ==.
                           00006F  1466 	C$main.c$22$1$8 ==.
                                   1467 ;	Z:\micro\delay_us\main.c:22: void main (void)
                                   1468 ;	-----------------------------------------
                                   1469 ;	 function main
                                   1470 ;	-----------------------------------------
      0000D1                       1471 _main:
                           00006F  1472 	C$main.c$24$1$11 ==.
                                   1473 ;	Z:\micro\delay_us\main.c:24: Init_Device();
      0000D1 12 00 9D         [24] 1474 	lcall	_Init_Device
                           000072  1475 	C$main.c$25$1$11 ==.
                                   1476 ;	Z:\micro\delay_us\main.c:25: SFRPAGE = LEGACY_PAGE;
      0000D4 75 84 00         [24] 1477 	mov	_SFRPAGE,#0x00
                           000075  1478 	C$main.c$26$1$11 ==.
                                   1479 ;	Z:\micro\delay_us\main.c:26: P0=0; //apaga leds
      0000D7 75 80 00         [24] 1480 	mov	_P0,#0x00
                           000078  1481 	C$main.c$27$1$11 ==.
                                   1482 ;	Z:\micro\delay_us\main.c:27: while(1)
      0000DA                       1483 00102$:
                           000078  1484 	C$main.c$29$2$12 ==.
                                   1485 ;	Z:\micro\delay_us\main.c:29: P0_0 = 1;
      0000DA D2 80            [12] 1486 	setb	_P0_0
                           00007A  1487 	C$main.c$30$2$12 ==.
                                   1488 ;	Z:\micro\delay_us\main.c:30: delay_us(50000);
      0000DC 90 C3 50         [24] 1489 	mov	dptr,#0xc350
      0000DF 12 00 AA         [24] 1490 	lcall	_delay_us
                           000080  1491 	C$main.c$31$2$12 ==.
                                   1492 ;	Z:\micro\delay_us\main.c:31: P0_0 = 0;
      0000E2 C2 80            [12] 1493 	clr	_P0_0
                           000082  1494 	C$main.c$32$2$12 ==.
                                   1495 ;	Z:\micro\delay_us\main.c:32: delay_us(50000);
      0000E4 90 C3 50         [24] 1496 	mov	dptr,#0xc350
      0000E7 12 00 AA         [24] 1497 	lcall	_delay_us
      0000EA 80 EE            [24] 1498 	sjmp	00102$
                           00008A  1499 	C$main.c$34$1$11 ==.
                           00008A  1500 	XG$main$0$0 ==.
      0000EC 22               [24] 1501 	ret
                                   1502 	.area CSEG    (CODE)
